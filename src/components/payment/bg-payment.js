  ...
  return (
    <div className="container bg-white p-4 rounded">
      <div className="colright">
        <div className="customer" style={{ textAlign: "justify" }}>
          <h3 className="title">
            <span className="image">
              <img
                src="/PublishingImages/Lists/Sn%20phm%20dch%20v/AllItems/icon1.png"
                alt=""
              />
            </span>

            <span className="text">Giới thiệu dịch vụ</span>
          </h3>
          <div className="excerpt">
            <p>
              Dịch vụ Cổng thanh toán NAPAS&nbsp;là dịch vụ NAPAS cung cấp cho
              các Ngân hàng/Tổ chức cho phép chủ thẻ nội địa, thẻ quốc tế do
              Ngân hàng/Tổ chức phát hành thực hiện giao dịch thanh toán hóa đơn
              hàng hóa, dịch vụ trên các kênh bán hàng trực tuyến (website,
              mobile app, khác) của các đơn vị cung ứng hàng hóa, dịch vụ thương
              mại điện tử có kết nối với NAPAS.
            </p>
            <div className="image">
              <img
                src="/PublishingImages/Lists/Sn%20phm%20dch%20v/AllItems/1.4-Dịch-vụ-thanh-toán-trực-tuyến.png"
                alt=""
                style={{ width: "599px" }}
              />
              &nbsp;
          ...
          <h3 className="title">
            <span className="image">
              <img
                src="/PublishingImages/Lists/Sn%20phm%20dch%20v/AllItems/icon6.png"
                alt=""
              />
            </span>

            <span className="text">Đặc điểm dịch vụ</span>
          </h3>
          <div className="excerpt">
            <ul className="list-item">
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Hỗ trợ
                thanh toán đối với thẻ nội địa của gần 40 ngân hàng trong nước
                và thẻ quốc tế mang thương hiệu Visa, MasterCard, American
                Express, JCB, Diners Club, Unionpay… được phát hành trên khắp
                thế giới.
              </li>
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Giải
                pháp hỗ trợ đa thiết bị (PC, tablet, smartphone) và đa đồng tiền
                thanh toán (191 đồng tiền) với các tính năng ưu việt như
                tokenization, thu tiền tự động định kỳ, quản lý rủi ro tiến
                tiến.
              </li>
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Áp dụng
                các tiêu chuẩn công nghệ bảo mật, quản lý rủi ro hàng đầu trong
                ngành Tài chính Ngân hàng.
              </li>
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Giải
                pháp mã hóa Tokenization cho thẻ quốc tế và nội địa cho phép
                khách hàng lưu lại thông tin thẻ dưới dạng mã hóa để phục vụ
                những lần thanh toán kế tiếp mà không cần nhập lại thông tin
                thẻ.
              </li>
            </ul>
          </div>
          <h3 className="title">
            <span className="image">
              <img
                src="/PublishingImages/Lists/Sn%20phm%20dch%20v/AllItems/icon2.png"
                alt=""
              />
            </span>
          ...
          <div className="excerpt">
            <h3 className="title title-black">
              Lợi ích dịch vụ mang lại cho Ngân hàng phát hành
            </h3>
            <ul className="list-item">
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Gia tăng
                tiện ích thanh toán trên thẻ của ngân hàng.
              </li>
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Tăng
                doanh số sử dụng thẻ của khách hàng.
              </li>
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Được
                chia sẻ lợi nhuận trên phí giao dịch thẻ.
              </li>
            </ul>
            <br />
            <h3 className="title title-black">
              Lợi ích dịch vụ mang lại cho Ngân hàng thanh toán
            </h3>
            <ul className="list-item">
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Gia tăng
              ...
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Tăng tập
                khách hàng doanh nghiệp chấp nhận thanh toán trực tuyến.
              </li>
              <li>
                <i className="fa fa-angle-right" aria-hidden="true"></i>Quản lý
          ...
          <h3 className="title">
            <span className="image">
              <img
                src="/PublishingImages/Lists/Sn%20phm%20dch%20v/AllItems/icon4.png"
                alt=""
              />
            </span>

            <span className="text">Danh sách đối tác</span>
          </h3>

          <div className="excerpt">
            <ul className="list-image"></ul>
            ...
            <ul className="list-image">
              ...
              <li>
                ...
                >
                  <img
                    alt=""
                    src="https://napas.com.vn/PublishingImages/viettin_bank_logo.png"
                  />
                </a>
              </li>
              ...
              <li>
                ...
                >
                  <img
                    alt=""
                    src="https://napas.com.vn/PublishingImages/publish_bank_logo.png"
                  />
                </a>
              </li>
            </ul>
            ...
            <h3 className="title title-black">
              Danh sách các đơn vị cung cấp hàng hóa dịch vụ
            </h3>
            <div className="hr"></div>
            &#8203;&#8203;
            <div id="ctl00_ctl16_g_c86dd40e_d5db_4325_ae37_2e7aff85c06c_ctl00_divVenders">
              ...
              <ul className="list-image">
                ...
                <li>
                  ...
                  >
                    <img
                      alt=""
                      src="https://napas.com.vn/PublishingImages/vietjet.png"
                    />
                  </a>
                </li>
                ...
                <li>
                  ...
                  >
                    <img
                      alt=""
                      src="https://napas.com.vn/PublishingImages/air_asia.png"
                    />
                  </a>
                </li>
              ...
              <h3 className="title title-center">VIỄN THÔNG</h3>
              <ul className="list-image">
                <li>
                  <a
                  ...
                  >
                    <img
                      alt=""
                      src="https://napas.com.vn/PublishingImages/mobiphone_logo.png"
                    />
                  </a>
                </li>
                ...
                <li>
                  ...
                  >
                    <img
                      alt=""
                      src="https://napas.com.vn/PublishingImages/vinaphone_logo.png"
                    />
                  </a>
                </li>
              ...
              <ul className="list-image">
                ...
                <li>
                  ...
                  >
                    <img
                      alt=""
                      src="https://napas.com.vn/PublishingImages/prudential_logo.png"
                    />
                  </a>
                </li>
              ...
              <ul className="list-image">
                ...
                <li>
                  ...
                  >
                    <img
                      alt=""
                      src="https://napas.com.vn/PublishingImages/ngan_luong_logo.png"
                    />
                  </a>
                </li>
              ...
              <h3 className="title title-center">
                GIẢI TRÍ – DU LỊCH – TIÊU DÙNG – KHÁC
              </h3>
              <ul className="list-image">
                <li>
